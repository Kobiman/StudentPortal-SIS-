...
exports.ProgramViewModel = void 0;
...
var ProgramViewModel = /** @class */ (function () {
    function ProgramViewModel() {
        ...
        this.getPrograms = function () { return __awaiter(_this, void 0, void 0, function () {
            var res, data, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, fetch(app_1.App.baseUri + "/api/Program/GetPrograms")];
                    case 1:
                        res = _a.sent();
                        if (!res.ok) {
                        }
    ...
    ProgramViewModel.prototype.bindList = function (id) {
        new BindingList2_1.BindingList2().bind(this, id);
    };
    ProgramViewModel.prototype.bind = function () {
        this.program = this.viewModelHelper.addPropertyChangeNotification(this.program);
    };
    ProgramViewModel.prototype.setupRules = function () {
        return [
            new validator_1.Rules("department", [new validator_1.Required(this.program.department)]),
            new validator_1.Rules("name", [new validator_1.Required(this.program.name)]),
            new validator_1.Rules("duration", [new validator_1.Required(this.program.duration)]),
        ];
    };
    ProgramViewModel.prototype.addSpecialization = function (data) {
        this.program.specializations.push(data);
    };
    ProgramViewModel.prototype.removeSpecialization = function (index) {
        this.program.specializations.splice(index, 1);
    };
    ProgramViewModel.prototype.save = function () {
        var _this = this;
        var rules = this.setupRules();
        var errors = this.validator.addRules(rules).validate();
        this.viewModelHelper.showErrors(errors);
        if (!this.validator.hasErrors) {
            var department = this.departments.find(function (x) { return x.name === _this.program.department; });
            ...
            fetch(app_1.App.baseUri + "/api/Program/AddProgram", options)
                .then(function (res) { return res.json(); })
                .then(function (res) {
                _this.program = new program_1.Program();
                _this.bind();
                _this.getPrograms();
...
exports.ProgramViewModel = ProgramViewModel;
