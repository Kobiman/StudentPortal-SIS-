...
var LookupVm = /** @class */ (function () {
    function LookupVm() {
        ...
        this.getInstitutions = function () { return __awaiter(_this, void 0, void 0, function () {
            var res, data, institution, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        institution = new institution_1.Institution();
        ...
        this.getLookups = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, fetch(app_1.App.baseUri + "/api/Lookup/GetLookups")];
                    case 1:
                        res = _a.sent();
                        if (!res.ok) {
                        }
                    ...
                    case 2:
                        ...
                        new BindingList2_1.BindingList2().bind(this, "lookups");
                        return [3 /*break*/, 4];
                    case 3:
                        error_2 = _a.sent();
                        return [3 /*break*/, 4];
    ...
    LookupVm.prototype.setupRules = function () {
        return [
            new validator_1.Rules("name", [new validator_1.Required(this.lookup.name)]),
            new validator_1.Rules("type", [new validator_1.Required(this.lookup.type)]),
            new validator_1.Rules("institution", [new validator_1.Required(this.lookup.institution)]),
        ];
    };
    LookupVm.prototype.save = function () {
        var _this = this;
        var rules = this.setupRules();
        var errors = this.validator.addRules(rules).validate();
        this.viewModelHelper.showErrors(errors);
        if (!this.validator.hasErrors) {
            var institution = this.institutions.find(function (x) { return x.name === _this.lookup.institution; });
            ...
            fetch(app_1.App.baseUri + "/api/Lookup/AddLookup", options)
                .then(function (res) { return res.json(); })
                .then(function (res) {
                _this.lookup = new lookup_1.Lookup();
                _this.bind();
                _this.getLookups();
