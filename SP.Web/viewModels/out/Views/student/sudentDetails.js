                ...
                createElement("div", { class: "sp-row-col-2-2-1" },
                    ...
                    createElement("div", { clas: "profile-fields" },
                        createElement("div", { class: "tab" },
                            ...
                            createElement("button", { style: "width:11%;", onclick: () => {
                                ...
                                "Save"),
                            createElement("button", { id: "btnEdit", value: "yes", style: "visibility:hidden; width:11%;", onclick: () => {
                                    let input = document.querySelectorAll("[input]");
                                    input.forEach(function (item) {
                                        item.toggleAttribute("disabled");
                                    });
...
//# sourceMappingURL=sudentDetails.js.map