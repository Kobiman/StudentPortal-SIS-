    ...
    constructor(_vm) {
        ...
        this.addClickEvent = () => __awaiter(this, void 0, void 0, function* () {
            let showStudent = (evt) => __awaiter(this, void 0, void 0, function* () {
                ...
                document.getElementById("code").value = this._vm.course.code;
                document.getElementById("name").value = this._vm.course.courseName;
                document.getElementById("credit").value = this._vm.course.credit.toString();
                document.getElementById("department").value = this._vm.course.department;
                document.getElementById("code1").textContent = this._vm.course.code;
                document.getElementById("name1").textContent = this._vm.course.courseName;
                document.getElementById("credit1").textContent = this._vm.course.credit.toString();
                document.getElementById("department1").textContent = this._vm.course.department;
            });
