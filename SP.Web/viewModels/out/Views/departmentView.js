    ...
    constructor(_vm) {
        ...
        this.addClickEvent = () => __awaiter(this, void 0, void 0, function* () {
            let showStudent = (evt) => __awaiter(this, void 0, void 0, function* () {
                ...
                document.getElementById("code").value = this._vm.department.code;
                document.getElementById("name").value = this._vm.department.name;
                document.getElementById("schoolName").value = this._vm.department.schoolName;
                document.getElementById("HoD").value = this._vm.lecturerName;
        ...
        this._vm.departmentUpdatedCommand.add(() => {
            document.getElementById(this._vm.department.departmentId).innerHTML = this._vm.department.name;
        });
    }
    oninitialized() {
